...
class ArticleServiceTest {
    ...
    void givenArticleInfo_whenSavingArticle_thenSavesArticle() {
        ...
        // When
        sut.saveArticle(ArticleDto.of(LocalDateTime.now(), "BHKIM", "title", "content", "#C++"));
    ...
    @Test
    void givenArticleIdAndArticleInfo_whenUpdatingArticle_thenUpdatesArticle() {

        // Given
        given(articleRepository.save(any(Article.class))).willReturn(null);

        // When
        sut.updateArticle(1L, ArticleUpdateDto.of("title2222", "content", "#C++"));
